...
ADD TO SUMMARY 
Future questions - can we determine which initializations will be succesful.  More interestingly, can we perform Masked Language Modeling concurrently with classification to produce better outcome using adapter architecture.  This would be ideal using a parallel architecture, but has significant hurdle with the different nature of tasks.
