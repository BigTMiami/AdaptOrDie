...
\textbf{Experiments Setup.}
The goal of this set of experiments was to evaluate the effect of the TAPT pre-training on the baseline performance while varying differen parameters, such as the size of the training set, the number of training epochs, the sources of the pretraining, and the learning rate.

\textbf{[Tony: Add details here]}

\textbf{Results and Analysis.}

Table \ref{table:7}, Table \ref{table:8}, \ref{table:9}, and \ref{table:10} shows the results of the experiments.
\textbf{[Tony: Add details here]}
